...
class WomenNewPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("WOMEN NEW",textAlign: TextAlign.center ,),backgroundColor: Colors.black,
...
class WomenTopsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("TOPS",textAlign: TextAlign.center ,),backgroundColor: Colors.black,
