...
import 'package:relt/view/categoriespages/mencategory.dart';
import 'package:relt/view/categoriespages/womenscategory.dart';
...
class MaincategoryState extends State<Maincategory> {
    ...
    if (_womenSelected) {
      ...
      switch (categoryName) {
        ...
        case 'Others Accessories':
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const MenAccessoriesPage()),
          );
          break;
        default:
          // Handle unknown category
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("CATEGORIES ",textAlign: TextAlign.center ,),backgroundColor: Colors.black,
       actions: [
          IconButton(
            ...
            children: [
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: _womenSelected ? Colors.black : Colors.grey,
                ),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: _menSelected ? Colors.black : Colors.grey,
                ),
